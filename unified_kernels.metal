...
// ============================================================================
// Directly outputs Q, K, V in [H, M, D] layout to completely bypass a transpose kernel
...
// ============================================================================
// 6. FUSED FLASHATTENTION ENGINE WITH CAUSAL MASKING (FP16 & Q8_0)
// ============================================================================
...
// FlashAttention FP16 (32x16 Tile - Optimal Latency & High Register Occupancy on M4)
kernel void flash_attn_fp16_causal(
    ...
    uint tid     [[thread_index_in_threadgroup]])
{
    ...
    for (uint b_c = 0; b_c < loop_tiles; b_c++) {
        ...
        if (next_b_c < loop_tiles) {
            load_kv_tile_fp16<TG_SIZE, BC>(K, V, smem_K[nxt_buf], smem_V[nxt_buf], h, next_b_c * BC, M, tid);
        }
